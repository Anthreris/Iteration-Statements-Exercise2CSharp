namespace IterationStatements
{
    public class Program
    {
        ...
        public static void AreNumbersEqual(int numOne, int numTwo)
        {
            if (numOne == numTwo)
            {
                Console.WriteLine($"{numOne} and {numTwo} are equivalent.");
            }
            else
            {
                Console.WriteLine($"{numOne} and {numTwo} aren't equivalent.");
            }
        }
        ...
        public static void IsPostive (int number)
        {
            if (number > 0)
            {
            ...
            {
                Console.WriteLine("Neither positive or negative. The number is zero.");
            }
            else
            {
        ...
        public static void CanVote()
        {
            ...
            {
                Console.WriteLine($"Sorry, {userAge} years old isn't old enough to vote!");
            }
        }
        ...
        public static void IsInRange()
        {
            ...
            {
                Console.WriteLine($"{userNumber} is within the range.");
            }
            else
            {
                Console.WriteLine($"{userNumber} is outside of the range.");
            }
        }
